...
## Описание проекта.
Платформу для онлайн-обучения. Разработка LMS-системы, 
...
2. директория fixture - содержит сохраненные фикстуры с данными;
3. директория media - содержит загруженные медиа файлы;
4. приложения: materials, users
